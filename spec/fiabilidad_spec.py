        ...
        with context('si es CT'):
            ...
            with context('el tipo posicion es proteccion'):
                with it('must be 2'):
                    ...
                    cini = self.fiab.cini
                    expect(cini[6]).to(equal('2'))
            with context('el tipo posicion es altres'):
                with it('must be blank'):
                    self.fiab.tipo_posicion = 'A'
                    cini = self.fiab.cini
                    expect(cini[6]).to(equal(' '))
